...
tasks = {
    ...
    "4":  ("Static task",                 run_static_trials),
    "5":  ("Dynamic task 1",              run_dynamic_trials),
    "6":  ("Dynamic task 2",              run_dynamic_trials),
    "7":  ("Dynamic task 3",              run_dynamic_trials)
}
...
def terminate_task():
    ...
    thank_you_msg = visual.TextStim(
        win, 
        text = "The experiment is now over. Thank you for participating!", 
        color="white", 
        height = 30,
